...
public abstract class TablutClient implements Runnable {
	 ...
	 * @throws IOException
	 */
	public TablutClient(String player, String name, int timeout, String ip)
	 ...
	 */
	public void serverWriteAction(Action action) throws IOException, ClassNotFoundException {
	 ...
	 */
	public void serverWriteName() throws IOException, ClassNotFoundException {
	 ...
	 */
	public void serverReadState() throws ClassNotFoundException, IOException {
