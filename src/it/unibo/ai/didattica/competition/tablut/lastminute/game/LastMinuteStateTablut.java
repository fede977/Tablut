...
public class LastMinuteStateTablut {
	...
	public LastMinuteStateTablut(int depth) {
		this.setBoard(new Pawn[LastMinuteStateTablut.WIDTH][LastMinuteStateTablut.HEIGHT]);
		this.setBoardArea(new Area[LastMinuteStateTablut.WIDTH][LastMinuteStateTablut.WIDTH]);
		this.initBoard();
		this.setTurn(Turn.WHITE);
		this.setCurrentDepth(depth);
	}
	
	public LastMinuteStateTablut stateAdapter(State state) {
		LastMinuteStateTablut result = new LastMinuteStateTablut(4);
	...
	public int getNumberCloseToTheKingOf(Pawn color) {
		...
		if((kingPosition[1] + 1) < (LastMinuteStateTablut.KING_POSITION * 2 + 1) && this.getPawn(kingPosition[0], kingPosition[1] + 1).equals(color)) {
			pawnsThatSurroundKing++;
		}
		if((kingPosition[0] - 1) >= 0 && this.getPawn(kingPosition[0] - 1, kingPosition[1]).equals(color)) {
			pawnsThatSurroundKing++;
		}
		if((kingPosition[0] + 1) < (LastMinuteStateTablut.KING_POSITION * 2 + 1) && this.getPawn(kingPosition[0] + 1, kingPosition[1]).equals(color)) {
			pawnsThatSurroundKing++;
		}
		...
		if(((kingPosition[0] + 1) < (LastMinuteStateTablut.KING_POSITION * 2 + 1)) && ((kingPosition[1] + 1) < (LastMinuteStateTablut.KING_POSITION * 2 + 1)) 
				&& this.getPawn(kingPosition[0] + 1, kingPosition[1] + 1).equals(color)) {	
			pawnsThatSurroundKing++;
		}
		if(((kingPosition[0] - 1) >= 0) && ((kingPosition[1] + 1) < (LastMinuteStateTablut.KING_POSITION * 2 + 1))
				&& this.getPawn(kingPosition[0] - 1, kingPosition[1] + 1).equals(color)) {
			pawnsThatSurroundKing++;
		}
		if((kingPosition[0] + 1) < (LastMinuteStateTablut.KING_POSITION  * 2 + 1) && ((kingPosition[1] - 1) >= 0) 
				&& this.getPawn(kingPosition[0] + 1, kingPosition[1] - 1).equals(color)) {
			pawnsThatSurroundKing++;
		}
	...
	public int getNumberOfCampsCloseToKing() {
		...
		if((kingPosition[1] + 1) < (LastMinuteStateTablut.KING_POSITION * 2 + 1) && this.getArea(kingPosition[0], kingPosition[1] + 1).equals(Area.CAMPS)) {
			campsCloseToTheKing++;
		}
		if((kingPosition[0] - 1) >= 0 && this.getArea(kingPosition[0] - 1, kingPosition[1]).equals(Area.CAMPS)) {
			campsCloseToTheKing++;
		}
		if((kingPosition[0] + 1) < (LastMinuteStateTablut.KING_POSITION * 2 + 1) && this.getArea(kingPosition[0] + 1, kingPosition[1]).equals(Area.CAMPS)) {
			campsCloseToTheKing++;
		}
	...
	public int hasBlackWon() {
		...
		if(((LastMinuteStateTablut.KING_POSITION - 1) >= 0)
				&& this.getPawn(LastMinuteStateTablut.KING_POSITION, LastMinuteStateTablut.KING_POSITION - 1).equals(Pawn.KING)) {
			if(((LastMinuteStateTablut.KING_POSITION + 1) < this.getBoard().length) && ((LastMinuteStateTablut.KING_POSITION - 2) >= 0)
					&& ((LastMinuteStateTablut.KING_POSITION + 1) < this.getBoard().length)
					&& (this.getPawn(LastMinuteStateTablut.KING_POSITION, LastMinuteStateTablut.KING_POSITION - 2).equals(Pawn.BLACK)
					&& this.getPawn(LastMinuteStateTablut.KING_POSITION - 1, LastMinuteStateTablut.KING_POSITION - 1).equals(Pawn.BLACK)
					&& this.getPawn(LastMinuteStateTablut.KING_POSITION + 1, LastMinuteStateTablut.KING_POSITION - 1).equals(Pawn.BLACK))
					){
				return 1;
			}
			
		} else if(((LastMinuteStateTablut.KING_POSITION + 1) < this.getBoard().length)
				&& this.getPawn(LastMinuteStateTablut.KING_POSITION, LastMinuteStateTablut.KING_POSITION + 1).equals(Pawn.KING)) {
			if(((LastMinuteStateTablut.KING_POSITION + 2) < this.getBoard().length)
					&& ((LastMinuteStateTablut.KING_POSITION - 1) >= 0)
					&& (this.getPawn(LastMinuteStateTablut.KING_POSITION, LastMinuteStateTablut.KING_POSITION + 2).equals(Pawn.BLACK)
					&& this.getPawn(LastMinuteStateTablut.KING_POSITION + 1, LastMinuteStateTablut.KING_POSITION + 1).equals(Pawn.BLACK)
					&& this.getPawn(LastMinuteStateTablut.KING_POSITION - 1, LastMinuteStateTablut.KING_POSITION + 1).equals(Pawn.BLACK)) 
					) {
		...
		} else if(((LastMinuteStateTablut.KING_POSITION - 1) >= 0)
				&& this.getPawn(LastMinuteStateTablut.KING_POSITION - 1, LastMinuteStateTablut.KING_POSITION).equals(Pawn.KING)) {
			if((((LastMinuteStateTablut.KING_POSITION - 2) >= 0)
					&& ((LastMinuteStateTablut.KING_POSITION + 1) < this.getBoard().length)
					&& this.getPawn(LastMinuteStateTablut.KING_POSITION - 1, LastMinuteStateTablut.KING_POSITION - 1).equals(Pawn.BLACK)
					&& this.getPawn(LastMinuteStateTablut.KING_POSITION - 2, LastMinuteStateTablut.KING_POSITION).equals(Pawn.BLACK)
					&& this.getPawn(LastMinuteStateTablut.KING_POSITION - 1, LastMinuteStateTablut.KING_POSITION + 1).equals(Pawn.BLACK))
					) {
				return 1;
			}
	...
	public void initBoard() {
		...
		this.setPawn(LastMinuteStateTablut.KING_POSITION,  LastMinuteStateTablut.KING_POSITION, Pawn.THRONE);
		this.setPawn(LastMinuteStateTablut.KING_POSITION,  LastMinuteStateTablut.KING_POSITION, Pawn.KING);
	...
	public LastMinuteStateTablut clone() {
		LastMinuteStateTablut result = new LastMinuteStateTablut(this.getCurrentDepth());
	...
	public boolean equals(Object obj) {
		...
		if (this.getClass() != obj.getClass())
			return false;
		LastMinuteStateTablut other = (LastMinuteStateTablut) obj;
